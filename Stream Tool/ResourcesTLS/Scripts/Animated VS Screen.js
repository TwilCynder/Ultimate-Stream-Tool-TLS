...
dynamicallyLoadScript("Resources//Scripts//ScoreboardInfoConversion.js")
...
function updateColor(gradEL, textBGEL, color, i, gamemode) {
	...
	textBGEL.src = 'ResourcesTLS/Overlay/VS Screen/Text BGs/' + gamemode + '/' + color + '.png';
