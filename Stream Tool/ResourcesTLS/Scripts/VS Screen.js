...
let defaultCaster1Position

window.onload = init;
function init() {

	defaultCaster1Position = document.getElementById('caster1').getBoundingClientRect().x + "px";
...
function getData(scInfo) {
	...
	if (caster2 == "") {
		//if there is no caster2, make caster1 centered
		document.getElementById('caster1').style.left = '820px'
	} else {
		document.getElementById('caster1').style.left = defaultCaster1Position
	}
}
